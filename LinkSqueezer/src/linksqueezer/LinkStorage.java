...
/**
 * The LinkStorage class takes a filepath as a parameter in the constructor, which represents the path to the file where the links are stored.
 */
public class LinkStorage {
    ...
    /**
     * Creates a new instance of the LinkStorage class with the specified filepath.
     ...
     * @return the Link object with the specified short URL, or null if no such link exists in the file
     * @throws IOException if an I/O error occurs while reading from the file
     */
     ...
     * @return the Link object with the specified alias, or null if no such link exists in the file
     * @throws IOException if an I/O error occurs while reading from the file
     */
